...
const englishTranslations: Translations = {
  ...
  dialImmediately: "Dial 108 immediately. Don't wait to confirm symptoms.",
  ...
  dialAsSoonAsStroke: "Dial 108 as soon as you suspect stroke.",
  ...
  dialRightAway: "Dial 108 right away. Do not delay.",
  ...
  mentionSymptomsInfection: "Dial 108. Mention symptoms and any known infection.",
...
const hindiTranslations: Translations = {
  ...
  call112Now: "अभी 108 पर कॉल करें",
  findAED: "AED खोजें",
  ...
  dialImmediately: "तुरंत 108 डायल करें। लक्षणों की पुष्टि का इंतजार न करें।",
  ...
  dialAsSoonAsStroke: "स्ट्रोक का संदेह होते ही 108 डायल करें।",
  ...
  dialRightAway: "तुरंत 108 डायल करें। देरी न करें।",
  ...
  mentionSymptomsInfection: "108 डायल करें। लक्षण और ज्ञात संक्रमण का उल्लेख करें।",
  ...
  dialImmediatelyIfSevereBleeding: "यदि खून बहना गंभीर है या नहीं रुक रहा तो तुरंत 108 डायल करें।",
...
const teluguTranslations: Translations = {
  ...
  call112Now: "ఇప్పుడే 108 కాల్ చేయండి",
  ...
  dialImmediately: "వెంటనే 108 డయల్ చేయండి. లక్షణాలను నిర్ధారించడానికి వేచి ఉండకండి.",
  ...
  dialAsSoonAsStroke: "స్ట్రోక్ అనుమానం వచ్చిన వెంటనే 108 డయల్ చేయండి.",
  ...
  dialRightAway: "వెంటనే 108 డయల్ చేయండి. ఆలస్యం చేయకండి.",
  ...
  mentionSymptomsInfection: "108 డయల్ చేయండి. లక్షణాలు మరియు తెలిసిన సంక్రమణను పేర్కొనండి.",
  ...
  dialImmediatelyIfSevereBleeding: "రక్తస్రావం తీవ్రంగా ఉంటే లేదా ఆగకపోతే వెంటనే 108 డయల్ చేయండి।",
